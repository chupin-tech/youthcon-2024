...
import com.chupintech.youthcon2024.homesummary.service.NotificationAddCommand;
...
public class HomeSummaryNotificationEventListener implements EventListener<NotificationEvent> {
	...
	public void onEvent(final NotificationEvent event) {
		final NotificationAddCommand command = new NotificationAddCommand(event.count());

		service.addNotificationCount(command);
	}
}
